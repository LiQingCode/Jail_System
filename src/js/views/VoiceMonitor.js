...
import { Col, Row, Menu, Typography, DatePicker, Button, Space, Card, List, Tag, Layout, Divider } from 'antd';
import { CustomerServiceFilled, AppstoreFilled, RollbackOutlined, PlayCircleFilled, UserOutlined, SearchOutlined, HomeOutlined, RightOutlined } from '@ant-design/icons';
                ...
                <Row justify="center">
                    <Col span={18}>
                        <Space className='layout-sapce'>
                            ...
                            <Menu onClick={onClick} selectedKeys={['voiceMonitor']} mode="horizontal" items={items} />
                            <Divider type="vertical" />
